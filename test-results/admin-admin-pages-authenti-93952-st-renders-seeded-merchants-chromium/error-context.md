...
- Name: admin.spec.ts >> admin pages (authenticated as admin) >> merchants list renders seeded merchants
...
Locator: getByText(/TechWorld/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/TechWorld/i).first()
